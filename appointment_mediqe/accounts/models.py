...
class UserProfile(models.Model):
    ...
    chronic_conditions = models.TextField()       # Medical conditions (e.g., diabetes, asthma)
    license_number = models.CharField(max_length=50)  # License number (for doctors/nurses)
